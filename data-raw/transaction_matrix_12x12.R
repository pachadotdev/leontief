...
names_12 <- c("agriculture_fishing", "mining", "manufacturing_industry", "electricity_gas_water",
              "construction", "retail_hotels_restaurants", "transport_communications_information",
              "financial_services", "real_state", "business_services", "personal_services",
              "public_administration")

names2_12 <- c("intermediate_total_demand", "household_consumption", "non_profit_consumption",
