# Getting help with inputoutput

Thanks for using inputoutput. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/inputoutput/issues) to make sure the 
